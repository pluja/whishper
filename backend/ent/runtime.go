...
func init() {
	...
	transcriptionDescTask := transcriptionFields[3].Descriptor()
	...
	transcriptionDescDevice := transcriptionFields[4].Descriptor()
	...
	transcriptionDescModelSize := transcriptionFields[5].Descriptor()
	...
	transcriptionDescCreatedAt := transcriptionFields[9].Descriptor()
