...
func (*Transcription) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case transcription.FieldStatus, transcription.FieldLanguage, transcription.FieldTask, transcription.FieldDevice, transcription.FieldModelSize, transcription.FieldSourceUrl, transcription.FieldFileName:
