...
func (Transcription) Fields() []ent.Field {
	return []ent.Field{
		...
		field.String("duration").StructTag(`json:"duration"`).Default("??"),
		...
		field.Int64("speaker_min").StructTag(`json:"speaker_min"`).Optional(),
		field.Int64("speaker_max").StructTag(`json:"speaker_max"`).Optional(),
