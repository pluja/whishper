...
func (tu *TranscriptionUpdate) SetSpeakerMin(i int64) *TranscriptionUpdate {
	tu.mutation.ResetSpeakerMin()
	tu.mutation.SetSpeakerMin(i)
	return tu
}

// SetNillableSpeakerMin sets the "speaker_min" field if the given value is not nil.
func (tu *TranscriptionUpdate) SetNillableSpeakerMin(i *int64) *TranscriptionUpdate {
	if i != nil {
		tu.SetSpeakerMin(*i)
	}
	return tu
...
func (tu *TranscriptionUpdate) AddSpeakerMin(i int64) *TranscriptionUpdate {
	tu.mutation.AddSpeakerMin(i)
	return tu
}

// ClearSpeakerMin clears the value of the "speaker_min" field.
func (tu *TranscriptionUpdate) ClearSpeakerMin() *TranscriptionUpdate {
	tu.mutation.ClearSpeakerMin()
	return tu
}

// SetSpeakerMax sets the "speaker_max" field.
func (tu *TranscriptionUpdate) SetSpeakerMax(i int64) *TranscriptionUpdate {
	tu.mutation.ResetSpeakerMax()
	tu.mutation.SetSpeakerMax(i)
	return tu
}

// SetNillableSpeakerMax sets the "speaker_max" field if the given value is not nil.
func (tu *TranscriptionUpdate) SetNillableSpeakerMax(i *int64) *TranscriptionUpdate {
	if i != nil {
		tu.SetSpeakerMax(*i)
	}
	return tu
...
func (tu *TranscriptionUpdate) AddSpeakerMax(i int64) *TranscriptionUpdate {
	tu.mutation.AddSpeakerMax(i)
	return tu
}

// ClearSpeakerMax clears the value of the "speaker_max" field.
func (tu *TranscriptionUpdate) ClearSpeakerMax() *TranscriptionUpdate {
	tu.mutation.ClearSpeakerMax()
	return tu
}
...
func (tu *TranscriptionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := tu.mutation.SpeakerMin(); ok {
		_spec.SetField(transcription.FieldSpeakerMin, field.TypeInt64, value)
	}
	if value, ok := tu.mutation.AddedSpeakerMin(); ok {
		_spec.AddField(transcription.FieldSpeakerMin, field.TypeInt64, value)
	}
	if tu.mutation.SpeakerMinCleared() {
		_spec.ClearField(transcription.FieldSpeakerMin, field.TypeInt64)
	}
	if value, ok := tu.mutation.SpeakerMax(); ok {
		_spec.SetField(transcription.FieldSpeakerMax, field.TypeInt64, value)
	}
	if value, ok := tu.mutation.AddedSpeakerMax(); ok {
		_spec.AddField(transcription.FieldSpeakerMax, field.TypeInt64, value)
	}
	if tu.mutation.SpeakerMaxCleared() {
		_spec.ClearField(transcription.FieldSpeakerMax, field.TypeInt64)
	}
...
// SetSpeakerMin sets the "speaker_min" field.
func (tuo *TranscriptionUpdateOne) SetSpeakerMin(i int64) *TranscriptionUpdateOne {
	tuo.mutation.ResetSpeakerMin()
	tuo.mutation.SetSpeakerMin(i)
	return tuo
}

// SetNillableSpeakerMin sets the "speaker_min" field if the given value is not nil.
func (tuo *TranscriptionUpdateOne) SetNillableSpeakerMin(i *int64) *TranscriptionUpdateOne {
	if i != nil {
		tuo.SetSpeakerMin(*i)
	}
	return tuo
...
// AddSpeakerMin adds i to the "speaker_min" field.
func (tuo *TranscriptionUpdateOne) AddSpeakerMin(i int64) *TranscriptionUpdateOne {
	tuo.mutation.AddSpeakerMin(i)
	return tuo
}

// ClearSpeakerMin clears the value of the "speaker_min" field.
func (tuo *TranscriptionUpdateOne) ClearSpeakerMin() *TranscriptionUpdateOne {
	tuo.mutation.ClearSpeakerMin()
	return tuo
}

// SetSpeakerMax sets the "speaker_max" field.
func (tuo *TranscriptionUpdateOne) SetSpeakerMax(i int64) *TranscriptionUpdateOne {
	tuo.mutation.ResetSpeakerMax()
	tuo.mutation.SetSpeakerMax(i)
	return tuo
}

// SetNillableSpeakerMax sets the "speaker_max" field if the given value is not nil.
func (tuo *TranscriptionUpdateOne) SetNillableSpeakerMax(i *int64) *TranscriptionUpdateOne {
	if i != nil {
		tuo.SetSpeakerMax(*i)
	}
	return tuo
...
// AddSpeakerMax adds i to the "speaker_max" field.
func (tuo *TranscriptionUpdateOne) AddSpeakerMax(i int64) *TranscriptionUpdateOne {
	tuo.mutation.AddSpeakerMax(i)
	return tuo
}

// ClearSpeakerMax clears the value of the "speaker_max" field.
func (tuo *TranscriptionUpdateOne) ClearSpeakerMax() *TranscriptionUpdateOne {
	tuo.mutation.ClearSpeakerMax()
	return tuo
}
...
func (tuo *TranscriptionUpdateOne) sqlSave(ctx context.Context) (_node *Transcription, err error) {
	...
	if value, ok := tuo.mutation.SpeakerMin(); ok {
		_spec.SetField(transcription.FieldSpeakerMin, field.TypeInt64, value)
	}
	if value, ok := tuo.mutation.AddedSpeakerMin(); ok {
		_spec.AddField(transcription.FieldSpeakerMin, field.TypeInt64, value)
	}
	if tuo.mutation.SpeakerMinCleared() {
		_spec.ClearField(transcription.FieldSpeakerMin, field.TypeInt64)
	}
	if value, ok := tuo.mutation.SpeakerMax(); ok {
		_spec.SetField(transcription.FieldSpeakerMax, field.TypeInt64, value)
	}
	if value, ok := tuo.mutation.AddedSpeakerMax(); ok {
		_spec.AddField(transcription.FieldSpeakerMax, field.TypeInt64, value)
	}
	if tuo.mutation.SpeakerMaxCleared() {
		_spec.ClearField(transcription.FieldSpeakerMax, field.TypeInt64)
	}
